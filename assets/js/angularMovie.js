angular.module('movieFinder', [])
    .controller('movieCtrl', function($scope, $http) {
            $scope.ButtonClick = function() {
                grab(); //watches the search input which refreshes every 800ms
            };
        });
        ...
        function grab() {
            $http.get('https://api.themoviedb.org/3/discover/movie?api_key=50c9867e013d532a54d305162ee29e35&with_genres=' + random)
        ...
        // $('#luckyButton').on("click", function(e) { //event handler for submit button
        //     event.preventDefault(); //prevents refreshing

        //     var genreArray = ['28', '12', '16', '35', '80', '99', '18', '10751', '14', '36', '27', '10402', '9648', '10749', '878', '10770', '53', '10752', '37'];
        //     var random = genreArray[Math.floor(Math.random() * genreArray.length)];

        //     var queryURL = "https://api.themoviedb.org/3/discover/movie?api_key=50c9867e013d532a54d305162ee29e35&with_genres=" + random;
